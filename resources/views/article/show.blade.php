    ...
    <div class="row">
        <div class="col">
            <div class="table w-full ">
                <div class="table-row" >
                    <div class="mx-12 flex justify-center" id="image">
                        @if($article->image)
                        <img class="w-full" src="{{ asset('storage/' . $article->image)}}" alt="" class="img-thumbnail">
                        @else
                        <img class="w-full" src="{{ asset('storage/defaults/article_default.jpg')}}" alt="" class="img-thumbnail">
                        @endif
                    </div>
                    <div class="h-4 mx-12" id="middlebar"></div>
                </div>
                <div class="table-row">
                    <div class="px-12 py-6 mx-12 mb-3 " id="article">
                        <div class="title text-4xl mb-1 font-extrabold">{{$article->title}}</div>
                        <div class="flex">
                            <div class="w-1/3">
                        ...
                        <p class="text-xl mt-10" id="content">{{$article->body}}</p>
                        <hr class="m-5">
