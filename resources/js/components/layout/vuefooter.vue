<template>
  <div class="flex px-64 pt-12 text-white" id="footer">
    <div class="w-1/2 h-48">
      <div class="text-xl">
        <div class="pb-3 text-5xl text-green-100">Cure Procrastination</div>
        <div class="text-xl">Contact Me</div>
        <i class="fa fa-envelope" style="font-size:24px"></i>
        <a href="mailto:analth355@gmail.com" class="text-lg text-gray-600">analth355@gmail.com</a>
      </div>
    </div>
    <div class="w-1/2 h-48">
      <div class="text-xl font-bold">About The Website</div>
