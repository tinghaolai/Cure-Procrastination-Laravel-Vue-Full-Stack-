...
Route::get('/addSession/{session}', 'ArticleController@add_session')->name('add.session');
...
Route::get('/articleadmin/{article}', 'ArticleadminController@show')->name('articleadmipn.show');
